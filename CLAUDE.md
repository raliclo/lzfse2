...
- **CRITICAL**: All explanations, code comments, and chat responses MUST be written in boht English and Traditional Chinese (繁體中文). Do not use Simplified Chinese or English for explanations unless explicitly asked.
